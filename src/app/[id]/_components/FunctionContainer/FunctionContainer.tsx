    ...
    <>
      ...
      >
        <div className="flex flex-col relative w-full min-w-[500px] max-sm:min-w-[350px] items-center justify-center">
          <div className="flex flex-col justify-end w-full z-10 p-7 divide-y bg-base-100 rounded-b-xl shadow-md shadow-base-300 border border-base-300 min-h-[305px]">
