...
const SignBtn = ({ setPending, pending, signText, signedText, onClick, wallet = false }: SignBtnProps) => {
  ...
  return (
    <button
      className="flex justify-between btn btn-primary bg-[#091e39] hover:bg-[#ae8c34] text-white rounded-md"
      onClick={handleClick}
    >
      {pending ? (
