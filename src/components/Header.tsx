        ...
        return (
          <li key={href}>
            <Link
              ...
              } hover:bg-secondary hover:shadow-md focus:!bg-secondary active:!text-neutral py-2 px-4 text-sm rounded-xl gap-2 grid grid-flow-col`}
            >
              {icon}
              <span>{label}</span>
            </Link>
...
export const Header = () => {
  ...
  return (
    <div className="sticky lg:static top-0 navbar bg-base-100 min-h-0 flex-shrink-0 justify-between z-[999] shadow-md shadow-secondary px-0 sm:px-2">
